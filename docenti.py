...
'''
la funzione is_cf_present_in_studenti riceve come parametro il codice fiscale dello studente e restituisce True se il codice fiscale è presente tra i docenti
