...
--
-- Table structure for table `sostenuti`
--

DROP TABLE IF EXISTS `sostenuti`;
...
CREATE TABLE `sostenuti` (
  ...
  CONSTRAINT `sostenuti_ibfk_1` FOREIGN KEY (`Esame`) REFERENCES `esami` (`CodEsame`),
  CONSTRAINT `sostenuti_ibfk_2` FOREIGN KEY (`Studente`) REFERENCES `studenti` (`CodiceFiscale`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sostenuti`
--

LOCK TABLES `sostenuti` WRITE;
/*!40000 ALTER TABLE `sostenuti` DISABLE KEYS */;
/*!40000 ALTER TABLE `sostenuti` ENABLE KEYS */;
UNLOCK TABLES;
